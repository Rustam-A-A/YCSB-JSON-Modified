...
public class CoreWorkload extends Workload {
   ...
   */
  public static final String FIELD_LENGTH_PROPERTY_DEFAULT = "10";
   ...
   * the value was changed from 1000 to 2000
   */
  public static final String MAX_SCAN_LENGTH_PROPERTY_DEFAULT = "2000";
  ...
  /**
   * Build a category field.
   */
  private String buildCategoryField(String key, String fieldkey) {
  ...
  /**
   * Build a latitude field.
   */
  private String buildRandomLatitude(double minLat, double maxLat) {
    Random theRandom = new Random();
    double theRandomValue;
    theRandomValue = minLat + (maxLat - minLat) * theRandom.nextDouble();

    return Double.toString(theRandomValue);
  }

  /**
   * Build a longitude field.
   */
  private String buildRandomLongitude(double minLong, double maxLong) {
    Random theRandom = new Random();
    double theRandomValue;
    theRandomValue = minLong + (maxLong - minLong) * theRandom.nextDouble();
